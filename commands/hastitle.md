...
- `titleID`: The ID of the title to check for
  - See Titles Section below for list of IDs
...
```plaintext
    ...
    THIRD_RATE_ORGANIZER                      = 78,
    SECOND_RATE_ORGANIZER                     = 79,
    FIRST_RATE_ORGANIZER                      = 80,
    ...
    DOWN_PIPER_PIPE_UPPERER                   = 139,
    KISSER_MAKE_UPPER                         = 140,
    TIMEKEEPER                                = 141,
    FORTUNE_TELLER_IN_TRAINING                = 142,
    TORCHBEARER                               = 143,
    TENSHODO_MEMBER                           = 144,
    CHOCOBO_TRAINER                           = 145,
    ...
    ONE_STAR_PURVEYOR                         = 182,
    TWO_STAR_PURVEYOR                         = 183,
    THREE_STAR_PURVEYOR                       = 184,
    FOUR_STAR_PURVEYOR                        = 185,
    FIVE_STAR_PURVEYOR                        = 186,
    DOCTOR_YORAN_ORAN_SUPPORTER               = 187,
    DOCTOR_SHANTOTTO_SUPPORTER                = 188,
    PROFESSOR_KORU_MORU_SUPPORTER             = 189,
    RAINBOW_WEAVER                            = 190,
    SHADOW_WALKER                             = 191,
...
```plaintext
    ...
    DYNAMIS_SAN_DORIA_INTERLOPER              = 297,
    DYNAMIS_BASTOK_INTERLOPER                 = 298,
    DYNAMIS_WINDURST_INTERLOPER               = 299,
    DYNAMIS_JEUNO_INTERLOPER                  = 300,
    DYNAMIS_BEAUCEDINE_INTERLOPER             = 301,
    DYNAMIS_XARCABARD_INTERLOPER              = 302,
...
```plaintext
    ...
    SILVER_HOOK                               = 427,
    COPPER_HOOK                               = 428,
    DYNAMIS_VALKURM_INTERLOPER                = 430,
    DYNAMIS_BUBURIMU_INTERLOPER               = 431,
    DYNAMIS_QUFIM_INTERLOPER                  = 432,
    DYNAMIS_TAVNAZIA_INTERLOPER               = 433,
...
```plaintext
    ...
    GRAND_GREEDALOX                           = 611,
    KARAHA_BARUHAS_RESEARCH_ASSISTANT         = 612,
...
```plaintext
    ...
    BORE_REPULSOR                             = 827,
    PALLORITUS_PUNISHER                       = 828,
    PUTRAXIA_PULVERIZER                       = 829,
    RANCIBUS_RAVAGER                          = 830,
    ALLUVION_ASSAILANT                        = 831,
    PERFIDIEN_PAINDEALER                      = 832,
    PLOUTON_PINCER                            = 833,
    FLEETSTALKER_FILETER                      = 834,
    SHOCKMAW_SUBJUGATOR                       = 835,
    GEODANCER                                 = 836,
    RUNIC_ENGRAVER                            = 837,
    ...
    SWORD_SAINT                               = 937,
    THE_FATED                                 = 938,
    PROTECTOR_OF_THE_SACRED_CITY              = 939,
    URMAHLULLU_USURPER                        = 940,
    BLAZEWING_BERATER                         = 941,
    COVEN_COLLAPSER                           = 942,
    PAZUZU_PERPLEXER                          = 943,
    WRATHARE_WAXER                            = 944,
    LUPINE_LIQUIDATOR                         = 945,
    RUBY_REPULSER                             = 946,
    DEVILS_DEMISE                             = 947,
    CUSTODIAN_OF_ULBUKA                       = 948,
    AZI_DAHAKA_ANNIHILATOR                    = 949,
    NAGA_RAJA_NULLIFIER                       = 950,
    QUETZALCOATL_PLUCKER                      = 951,
    PAKECET_PACIFIER                          = 952,
    DUKE_VEPAR_VANQUISHER                     = 953,
    VIRAVA_VEGETATOR                          = 954,
    BYAKKO_TAMER                              = 955,
    GENBU_CRACKER                             = 956,
    SEIRYU_CLIPPER                            = 957,
    SUZAKU_PLUCKER                            = 958,
    KIRIN_DISMANTLER                          = 959,
    VANQUISHER_OF_APATHY                      = 960,
    VANQUISHER_OF_COWARDICE                   = 961,
    VANQUISHER_OF_ENVY                        = 962,
    VANQUISHER_OF_ARROGANCE                   = 963,
    VANQUISHER_OF_RAGE                        = 964,
    PURGER_OF_THE_WARDER                      = 965,
    CONQUERER_OF_FEAR                         = 966,
    DAWNS_DELIGHT                             = 967,
    MAJU_MAULER                               = 968,
    YAKSHI_YANKER                             = 969,
    NEAK_NULLIFIER                            = 970,
    TELES_TERRIFIER                           = 971,
    ASSISTANT_EXTRAORDINAIRE                  = 972,
    EXALTED_FISHERMAN                         = 973,
    SAUCE_SUPREME                             = 974,
    FISH_WHISPERER                            = 975,
    ABYSSAL_PURVEYOR                          = 976,
    BANISHER_OF_THE_PROFANE                   = 977,
    SPIRIT_SEEKER                             = 978,
    ONE_EYED_JACK                             = 979,
    CURATOR_CULLER                            = 980,
    MASTER_CENTURION                          = 981,
    MASTER_BRAWLER                            = 982,
    MASTER_HEALER                             = 983,
    MASTER_WIZARD                             = 984,
    MASTER_WARLOCK                            = 985,
    ...
    MASTER_EVOKER                             = 995,
    MASTER_MAGUS                              = 996,
    MASTER_PRIVATEER                          = 997,
    MASTER_PUPPETEER                          = 998,
    MASTER_HEADLINER                          = 999,
    MASTER_ACADEMIC                           = 1000,
```
...
```plaintext
    MASTER_NATURALIST                         = 1001,
    MASTER_RUNEIST                            = 1002,
    ZERDE_ZAPPER                              = 1003,
    VINIPATA_VANQUISHER                       = 1004,
    SCHAH_SCRAPER                             = 1005,
    ALBUMEN_AGGRIVATOR                        = 1006,
    ONYCHOPHORA_OBLITERATOR                   = 1007,
    ERINYS_ENGULFER                           = 1008,
    HERALD_OF_A_NEW_AGE                       = 1009,
    PREVENTER_OF_THE_SECOND_COMING            = 1010,
    LUX_EX_TENEBRIS                           = 1011,
    THE_TRIUMPHANT                            = 1012,
    FU_FIGHTER                                = 1013,
    KYOU_KILLER                               = 1014,
    KEI_COMBUSTER                             = 1015,
    ...
    KIN_KICKER                                = 1017,
    OU_OBLITERATOR                            = 1018,
    DYNAMIS_SAN_DORIA_D_TRESPASSER            = 1019,
    DYNAMIS_SAN_DORIA_D_INFILTRATOR           = 1020,
    DYNAMIS_SAN_DORIA_D_DOMINATOR             = 1021,
    DYNAMIS_BASTOK_D_TRESPASSER               = 1022,
    DYNAMIS_BASTOK_D_INFILTRATOR              = 1023,
    DYNAMIS_BASTOK_D_DOMINATOR                = 1024,
    DYNAMIS_WINDURST_D_TRESPASSER             = 1025,
    DYNAMIS_WINDURST_D_INFILTRATOR            = 1026,
    DYNAMIS_WINDURST_D_DOMINATOR              = 1027,
    DYNAMIS_JEUNO_D_TRESPASSER                = 1028,
    DYNAMIS_JEUNO_D_INFILTRATOR               = 1029,
    DYNAMIS_JEUNO_D_DOMINATOR                 = 1030,
    MIMIC_MASHER                              = 1031,
    JUDGE_JURY_AND_EXECUTIONER                = 1032,
    ZEROINE_TO_HEROINE                        = 1033,
    ...
    THE_DECIDER                               = 1046,
    THE_ASCENDED                              = 1047,
    THE_SAVIOR_OF_VANADIEL                    = 1048,
    BLESSED_BY_THE_AVATARS                    = 1049,
    SEER_OF_SONGS                             = 1050,
    THE_ETERNAL_WIND                          = 1051,
    DEALAN_DHE_DIMMER                         = 1052,
    SGILI_STOMPER                             = 1053,
    U_BNAI_UNDERMINER                         = 1054,
    GOGMAGOG_GRINDER                          = 1055,
    ARISTAEUS_ASSAILER                        = 1056,
    MARMORKREBS_MAULER                        = 1057,
    GIGELORUM_GAGGER                          = 1058,
    RASKOVNICHE_RENDER                        = 1059,
    PROCNE_PUNISHER                           = 1060,
    HENWEN_HARRIER                            = 1061,
    XEVIOSO_ZAPPER                            = 1062,
    NGAI_NABBER                               = 1063,
    ...
    SERVANT_TO_THE_SERVANT                    = 1119,
    LEGENDARY_WOODWORKER                      = 1120,
    LEGENDARY_BLACKSMITH                      = 1121,
    LEGENDARY_GOLDSMITH                       = 1122,
    LEGENDARY_WEAVER                          = 1123,
    LEGENDARY_TANNER                          = 1124,
